...
export const suppliersApi = {
  list: (params) => request(`/api/suppliers${buildQuery(params)}`),
  getById: (id) => request(`/api/suppliers/${id}`),
  create: (body) => request('/api/suppliers', { method: 'POST', body: JSON.stringify(body) }),
  update: (id, body) => request(`/api/suppliers/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
