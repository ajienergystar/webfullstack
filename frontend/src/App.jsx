    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          {childPaths.filter((path) => !['/dashboard/pos/penjualan', '/dashboard/pos/riwayat', '/dashboard/pos/hold', '/dashboard/pos/refund', '/dashboard/finance/kas'].includes(path)).map((path) => (
