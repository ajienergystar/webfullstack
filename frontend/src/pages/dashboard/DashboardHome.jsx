...
import StatCardMetric from '../../components/dashboard/StatCardMetric'
...
export default function DashboardHome() {
  ...
  return (
    <PageShell
      title="Dashboard"
      description="Ringkasan penjualan dan inventori"
      loading={loading}
      loadingMessage="Memuat data POS..."
      error={error}
    ...
    >
      <div className="stats-row">
        ...
        <StatCardMetric
          ...
          value={`${stats.topProductName} (${stats.topProductSold} terjual)`}
          variant="purple"
          icon={ICONS.star}
        />
        <StatCardMetric
          label="Stok Menipis"
          value={`${stats.lowStockCount} produk perlu restock`}
          variant="blue"
          icon={ICONS.alert}
        />
      </div>

      <Panel title="Grafik Penjualan (7 Hari Terakhir)">
